...
QBShared.Weapons = {
	...
	-- Custom Weapons
-- Adjusted weights for realism
[`weapon_ak47`]             = { name = 'weapon_ak47', label = 'AK-47', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored', weight = 3000 },
[`weapon_m70`]              = { name = 'weapon_m70', label = 'M70', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored', weight = 2800 },
[`weapon_de`]               = { name = 'weapon_de', label = 'Desert Eagle', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in', weight = 1200 },
[`weapon_fnx45`]            = { name = 'weapon_fnx45', label = 'FN FNX45', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in', weight = 1300 },
[`weapon_glock17`]          = { name = 'weapon_glock17', label = 'PD Glock 17', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in', weight = 1100 },
[`weapon_m4`]               = { name = 'weapon_m4', label = 'PD M4A1', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored', weight = 3200 },
[`weapon_m9`]               = { name = 'weapon_m9', label = 'Beretta M9A3', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in', weight = 1100 },
[`weapon_m1911`]            = { name = 'weapon_m1911', label = 'M1911', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in', weight = 1200 },
[`weapon_uzi`]              = { name = 'weapon_uzi', label = 'UZI', ammotype = 'AMMO_SMG', damagereason = 'Riddled / Drilled / Finished / Submachine Gunned', weight = 2000 },
[`weapon_mac10`]            = { name = 'weapon_mac10', label = 'MAC-10', ammotype = 'AMMO_SMG', damagereason = 'Riddled / Drilled / Finished / Submachine Gunned', weight = 1800 },
[`weapon_mossberg`]         = { name = 'weapon_mossberg', label = 'Mossberg 500', ammotype = 'AMMO_SHOTGUN', damagereason = 'Devastated / Pulverized / Shotgunned', weight = 2500 },
[`weapon_remington`]        = { name = 'weapon_remington', label = 'Remington 870', ammotype = 'AMMO_SHOTGUN', damagereason = 'Devastated / Pulverized / Shotgunned', weight = 2400 },
[`weapon_scarh`]            = { name = 'weapon_scarh', label = 'PD SCAR-H', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored', weight = 3000 },
[`weapon_shiv`]             = { name = 'weapon_shiv', label = 'Shiv', ammotype = nil, damagereason = 'Knifed / Stabbed / Eviscerated', weight = 600 },
[`weapon_katana`]           = { name = 'weapon_katana', label = 'Katana', ammotype = nil, damagereason = 'Knifed / Stabbed / Eviscerated', weight = 800 },
[`weapon_sledgehammer`]     = { name = 'weapon_sledgehammer', label = 'Sledge Hammer', ammotype = nil, damagereason = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered', weight = 2800 },
[`weapon_ar15`]             = { name = 'weapon_ar15', label = 'PD AR-15', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored', weight = 2900 },
[`weapon_mk14`]             = { name = 'weapon_mk14', label = 'PD MK14', ammotype = 'AMMO_SNIPER', damagereason = 'Ended / Sniped / Shot down / Floored', weight = 3000 },
[`weapon_huntingrifle`]     = { name = 'weapon_huntingrifle', label = 'Hunting Rifle', ammotype = 'AMMO_SNIPER', damagereason = 'Ended / Sniped / Shot down / Floored', weight = 2900 },
[`weapon_mp9`]              = { name = 'weapon_mp9', label = 'MP9', ammotype = 'AMMO_SMG', damagereason = 'Riddled / Drilled / Finished / Submachine Gunned', weight = 1900 },
[`weapon_m110`]             = { name = 'weapon_m110', label = 'M110', ammotype = 'AMMO_SNIPER', damagereason = 'Ended / Sniped / Shot down / Floored', weight = 3000 },
[`weapon_hk416`]            = { name = 'weapon_hk416', label = 'HK-416', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored', weight = 3200 },
[`weapon_ak74`]             = { name = 'weapon_ak74', label = 'AK-74', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored', weight = 3100 },
[`weapon_aks74`]            = { name = 'weapon_aks74', label = 'AK-S74', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored', weight = 3100 },
[`weapon_glock22`]          = { name = 'weapon_glock22', label = 'Glock 22', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in', weight = 1100 },
[`weapon_glock18c`]         = { name = 'weapon_glock18c', label = 'Glock 18C', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in', weight = 1100 },
[`weapon_mp5`]              = { name = 'weapon_mp5', label = 'H&K MP5', ammotype = 'AMMO_SMG', damagereason = 'Riddled / Drilled / Finished / Submachine Gunned', weight = 2000 },
[`weapon_karambit`]         = { name = 'weapon_karambit', label = 'Karambit', ammotype = nil, damagereason = 'Knifed / Stabbed / Eviscerated', weight = 600 },
[`weapon_colbaton`]         = { name = 'weapon_colbaton', label = 'Baton', ammotype = nil, damagereason = 'Beat', weight = 800 },
